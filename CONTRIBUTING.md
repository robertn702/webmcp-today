...
This repo is split-licensed (see [README](README.md#license)). Your contribution is offered under the license of the part you touch: **AGPL-3.0-only** for `apps/web` and `packages/db`, **MIT** for `packages/schema`, `packages/mcp`, `packages/definitions`, and `apps/extension`.
