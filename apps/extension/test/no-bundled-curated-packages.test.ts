...
// Step 5b (U7) drops @webmcp-today/curated-packages from the extension entirely.
...
const NEEDLE = "@webmcp-today/curated-packages";
...
describe("bundled curated-packages dependency removal", () => {
  it("has no source or test file referencing @webmcp-today/curated-packages", () => {
  ...
  it("has no dependency on @webmcp-today/curated-packages in package.json", () => {
